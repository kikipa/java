package algorithms.structure.tree.bplus;// Searching on a B+ tree in Java

import java.util.*;

public class BPlustTree4 {
    int m;
    InternalNode root;
    LeafNode firstLeaf;
    ...
    public static void main(String[] args) {
        BPlustTree4 bpt = null;
        bpt = new BPlustTree4(3);
        bpt.insert(5, 33);
        bpt.insert(15, 21);
        bpt.insert(25, 31);
        bpt.insert(35, 41);
